...
void niv_difficulte(int difficulte){
  if (difficulte==3){
      printf("La difficulté sera donc difficile, tu as 15 secondes devant toi\n");
      for(int i=15;i>0;i--){ 
        printf("%d\n",i);
        sleep(1);
      }
    ...
    if (difficulte==2){
      printf("La difficulté sera donc moyenne, tu as 30 secondes devant toi\n");
      for(int i=30;i>0;i--){ 
        printf("%d\n",i);
        sleep(1);
      }
    ...
    if (difficulte==1){
      printf("La difficulté sera donc facile, tu as 45 secondes devant toi\n");
      for(int i=45;i>0;i--){ 
        printf("%d\n",i);
        sleep(1);
      }
